...
import tranhdayroi.utils.JAXBUtils;
...
public class PreloadServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            JAXBUtils.marshallObject(paintingList, Paintings.class, ous);
            
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(PreloadServlet.class.getName()).log(Level.SEVERE, null, ex);
